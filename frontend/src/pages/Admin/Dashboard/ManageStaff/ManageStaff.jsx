    ...
    <div className='add-staffs-box'>
      ...
      <form className='register-form'>
        ...
        <div className='register-form-div'>
          ...
          <div className='register-input-box'>
            <input disabled={clickedStaff} value={inputField.email} onChange={(event) => handleOnChange(event, "email")} className='input-box-register' type='text' placeholder='Email Id' />
          </div>
